...
class InstrumentApi(object):
    ...
    def instrument_get_composite_index(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.instrument_get_composite_index(callback=callback_function)
    ...
    def instrument_get_composite_index_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.instrument_get_composite_index_with_http_info(callback=callback_function)
